...
import product1 from '../Assarts/Product/75 (1).jfif'
import product2 from '../Assarts/Product/75 (2).jfif'
import product3 from '../Assarts/Product/75 (3).jfif'
import product4 from '../Assarts/Product/75 (4).jfif'
import product5 from '../Assarts/Product/75 (5).jfif'
import product6 from '../Assarts/Product/75 (6).jfif'
import product7 from '../Assarts/Product/75.jfif'
import product8 from '../Assarts/Product/751.jfif'
import { MdOutlineViewInAr, MdCropRotate } from "react-icons/md";
import { CiHeart } from "react-icons/ci";


const ReletatProduct = () => {
    return (
        <div className='row'>
